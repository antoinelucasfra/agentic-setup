...
metadata:
  ...
  version: "1.0"
  source: ~/.agents/github/agents/repo-architect.agent.md
---
...
3. **Suggest Collections**
   ...
   - Recommend relevant collections
...
6. **Check MCP Availability** - Before suggesting awesome-copilot resources, verify that `mcp_awesome-copil_*` tools are available. If not present, do NOT suggest or reference these tools.
