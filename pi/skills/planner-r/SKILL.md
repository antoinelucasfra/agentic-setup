---
name: planner-r
description: Expert R-focused planning specialist for R projects — R packages, Shiny apps, and tidyverse workflows. Use for feature implementation, architectural changes, or complex refactoring. Automatically activated for planning tasks.
license: MIT
metadata:
  author: Claude Code R Skills (ab604)
  version: "1.2.4"
